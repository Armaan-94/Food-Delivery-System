...
public class UserServiceFilter extends OncePerRequestFilter {
    ...
    private String getDbUsername() {
        ...
        return configJdbcTemplate.queryForObject(sql, String.class, "security.user.name.user-service");
    }
    
    private String getDbPassword() {
        String sql = "SELECT config_value FROM service_config WHERE config_key = ?";
        String passWithNoop = configJdbcTemplate.queryForObject(sql, String.class, "security.user.password.user-service");
